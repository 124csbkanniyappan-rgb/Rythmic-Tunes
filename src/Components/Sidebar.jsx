  ...
  return (
    <nav className="sidebar">
      <ul className="list-unstyled">
        <strong style={{display:"flex",justifyContent:"center",fontSize:"30px"}}>Delight Music</strong>
        <p style={{textAlign:"center", fontSize:12,color:"rgba(239, 239, 239, 1)",}}>Here we brings you joy and happiness through our music</p>
